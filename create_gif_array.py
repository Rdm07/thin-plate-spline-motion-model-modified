...
gif1 = imageio.get_reader('results/result_vox_chan_priyavrat.gif')
gif2 = imageio.get_reader('results/result_vox_chan_pyne.gif')
gif3 = imageio.get_reader('results/result_vox_chan_varun.gif')
gif4 = imageio.get_reader('results/result_vox_chan_fed.gif')
gif5 = imageio.get_reader('results/result_vox_chan_nadal.gif')

source_img1 = imageio.imread('assets/source_vox_priyavrat.png')
source_img2 = imageio.imread('assets/source_vox_pyne.jpg')
...
driving_gif = imageio.get_reader('assets/driving_vox_chan.mp4')
...
for frame_number in range(number_of_frames):
    ...
    gif_array.append(new_image)

imageio.mimsave(uri='results/vox_chan.gif', ims=gif_array)