...
class DenseMotionNetwork(nn.Module):
    ...
    def __init__(self, block_expansion, num_blocks, max_features, num_tps, num_channels, 
        ...
        # print(block_expansion, num_channels, num_tps, num_blocks, max_features, num_blocks, (num_channels * (num_tps+1) + num_tps*5+1))
    ...
    def forward(self, source_image, kp_driving, kp_source, bg_param = None, dropout_flag=False, dropout_p = 0):
        ...
        # print(heatmap_representation.size())
        # print(deformed_source.size())
        ...
        occlusion_map = []
        if self.multi_mask:
            # print(self.occlusion_num, self.up_nums, len(prediction))
